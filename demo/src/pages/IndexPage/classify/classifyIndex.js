      ...
      <div className="classify_box">
        ...
        <div className="classify_main">
          <ul className="classifyLeftBox" ref={this.leftScrollBox}>
            ...
            {classifyLeftBoxData&&classifyLeftBoxData.map((item,index)=>{
              return (
                <li key={item.id}  className={this.state.ind===index?"active":""} onClick={()=>{this.leftBoxChangeId(item.id,index)}}>{item.name}</li>
              )
            })}
            </div>
          ...
          <div className="classifyRightBox" ref={this.rightScrollBox}>
            ...
            <div className="RightBox_header">
              <img src={classifyLeftBoxData&&classifyRightBoxData.wap_banner_url} alt=""/>
              <span>{classifyLeftBoxData&&classifyRightBoxData.front_name}</span>
            </div>
