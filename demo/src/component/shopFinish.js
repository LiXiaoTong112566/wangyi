      ...
      <div className="shopFinshBox">
        ...
        <div className="shopFinshBox_main">
          <div className="shopFinshMain_top">
            ...
            <div className="num">x<span>{data.number}</span></div>
          </div>
